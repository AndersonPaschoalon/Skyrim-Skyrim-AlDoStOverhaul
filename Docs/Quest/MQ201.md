...
Objective **05a**: Meet Delphine in Riverwood
...
Objective **10a**: Meet Malborn in Solitude
...
Objective **20a**: Give Malborn the equipment
...
Objective **30a**: Meet Delphine at the stables
...
Objective **50a**: Create a distraction and get away from the party
...
Objective **55a**: (Optional) Retrieve your gear
Objective **60a**: Take the Cilderene diaries in a Chest in the Embassy 
...
Objective **55a**: (Optional) Retrieve your gear
Objective **60a**: Take the Cilderene diaries in a Chest in the Embassy 
Objective **70a**: Take the Key to scape using secret passage at the torture chamber
